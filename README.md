...
1.  **Create a Gatsby site.**
    ...
    gatsby new gatsby-starter-blog https://github.com/luizfelipeneves/gatsby-starter-blog
    ```
...
1.  **Open the source code and start editing!**
    ...
    Open the `gatsby-starter-blog` directory in your code editor of choice and edit `src/pages/index.js`. Save your changes and the browser will update in real time!
